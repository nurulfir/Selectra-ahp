  ...
  return (
    <nav
      className={`
        ...
        max-w-5xl w-[90%] px-4 sm:px-6 lg:px-8
    ...
    >
      <div className="flex justify-between items-center h-16">
        ...
        <Link to="/" className="flex items-center gap-2 group">
          <div className="w-10 h-10 bg-gradient-to-r from-cyan-500 to-blue-600 dark:from-cyan-600 dark:to-blue-700 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform">
      ...
      {/* Mobile Navigation */}
      {isOpen && (
        <div className="md:hidden py-4 border-t border-gray-200/40 dark:border-gray-700/40 transition-all">
          {navItems.map((item) => {
            const Icon = item.icon;
            return (
              <Link
                ...
                className={`flex items-center gap-3 px-4 py-3 rounded-lg font-medium transition-all mb-2 ${
                  isActive(item.path)
