...
const Home = () => {
  ...
  return (
    <div className="min-h-screen text-gray-800 bg-gradient-to-b from-white via-gray-50 to-gray-100 dark:from-gray-900 dark:via-gray-950 dark:to-black dark:text-gray-100 relative overflow-hidden">
      ...
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-blue-50 via-white to-blue-100 dark:from-gray-900 dark:via-gray-950 dark:to-gray-900 text-gray-900 dark:text-gray-100">
        <motion.div
          variants={fadeInUp}
          initial="hidden"
          whileInView="show"
